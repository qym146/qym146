...
// alert(m1);
if (m1 == 0) {
	monsterImage.src = "images/2.jpg";

} else {
	monsterImage.src = "images/1.jpg";
...
// alert(m1);
if (m1 == 0) {
	monsterImage2.src = "images/2.jpg";

} else {
	monsterImage2.src = "images/1.jpg";

}

// Game objects
var hero = {
	speed: 198 // movement in pixels per second
};

var Bullet = {
	speed: 648 // movement in pixels per second
};
var monster = {
};
var monster2 = {
